...
/** The start and end of a particular night at a [[gem.enum.Site]]. */
...
object TwilightBoundedNight extends TwilightBoundedNightOptics {
  ...
  def fromBoundTypeAndObservingNight(
    ...
    TwilightCalc
      .calculate(boundType, observingNight.toLocalDate.minusDays(1), observingNight.site.toPlace)
      .map {
        case (start, end) =>
  ...
  /** Constructs a [[gem.math.TwilightBoundedNight]] that ends on the given
    * local date for for the given site.
    *
    * Returns None if there's no sunset or sunrise for the specified
    * [[gsp.math.skycalc.TwilightBoundType]], [[gem.enum.Site]] and
    * [[java.time.LocalDate]].
    *
    * @group Constructors
    */
  ...
  /** Constructs a [[gem.math.TwilightBoundedNight]] that ends on the date
  ...
  /** Constructs a [[gem.math.TwilightBoundedNight]] for the observing night
    * that includes the given time at the specified site.
    *
    * Returns None if there's no sunset or sunrise for the specified
    * [[gsp.math.skycalc.TwilightBoundType]] and the observing night
    * that includes the given time at the specified site.
    *
    * @group Constructors
    */
  ...
  /** Returns a program in M that computes a [[gem.math.TwilightBoundedNight]]
