...
object GiapiStatusApply {
  ...
  val all: List[GiapiStatusApply] =
    List(GpiAdc, GpiUseAo, GpiAoOptimize, GpiUseCal, GpiFpmPinholeBias, GpiIntegrationTime, GpiNumCoadds, GpiMagI, GpiMagH, GpiCalEntranceShutter, GpiCalReferenceShutter, GpiCalScienceShutter, GpiEntranceShutter, GpiCalExitShutter, GpiPupilCamera, GpiSCPower, GpiSCAttenuation, GpiSrcVis, GpiSrcIR, GpiPolarizerDeplay, GpiObservationMode, GpiIFSFilter, GpiPPM, GpiFPM, GpiLyot, GpiAlignAndCalib, GpiIFSReadMode, GpiIFSStartX, GpiIFSStartY, GpiIFSEndX, GpiIFSEndY, GpiPolarizerAngle, GhostFiberAgitator1, GhostFiberAgitator2, GhostRedExposureTime, GhostRedExposureCount, GhostRedExposureBinningRcf, GhostRedExposureBinningCcf, GhostBlueExposureTime, GhostBlueExposureCount, GhostBlueExposureBinningRcf, GhostBlueExposureBinningCcf, GhostIFU1Bundle, GhostIFU2Bundle, GhostSRIFU1CoordsRADeg, GhostSRIFU1CoordsDecDeg, GhostSRIFU2CoordsRADeg, GhostSRIFU2CoordsDecDeg, GhostHRIFU1CoordsRADeg, GhostHRIFU1CoordsDecDeg, GhostHRIFU2CoordsRADeg, GhostHRIFU2CoordsDecDeg, GhostUserTarget0Name, GhostUserTarget0CoordsRADeg, GhostUserTarget0CoordsDecDeg, GhostUserTarget1Name, GhostUserTarget1CoordsRADeg, GhostUserTarget1CoordsDecDeg, GhostUserTarget2Name, GhostUserTarget2CoordsRADeg, GhostUserTarget2CoordsDecDeg, GhostUserTarget3Name, GhostUserTarget3CoordsRADeg, GhostUserTarget3CoordsDecDeg, GhostUserTarget4Name, GhostUserTarget4CoordsRADeg, GhostUserTarget4CoordsDecDeg, GhostUserTarget5Name, GhostUserTarget5CoordsRADeg, GhostUserTarget5CoordsDecDeg, GhostUserTarget6Name, GhostUserTarget6CoordsRADeg, GhostUserTarget6CoordsDecDeg, GhostUserTarget7Name, GhostUserTarget7CoordsRADeg, GhostUserTarget7CoordsDecDeg, GhostUserTargetCount)
