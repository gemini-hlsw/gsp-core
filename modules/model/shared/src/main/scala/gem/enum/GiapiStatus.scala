...
object GiapiStatus {
  ...
  /** @group Constructors */ case object GpiGuiding extends GiapiStatus("GpiGuiding", Instrument.Gpi, GiapiType.Int, "gpi:guiding")
  /** @group Constructors */ case object GpiAlignAndCalibState extends GiapiStatus("GpiAlignAndCalibState", Instrument.Gpi, GiapiType.Int, "gpi:alignCalibMode")
