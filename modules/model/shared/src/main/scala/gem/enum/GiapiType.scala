...
object GiapiType {
  ...
  /** @group Constructors */ case object String extends GiapiType("String")
  /** @group Constructors */ case object Int extends GiapiType("Int")
  /** @group Constructors */ case object Float extends GiapiType("Float")
  /** @group Constructors */ case object Double extends GiapiType("Double")
